...
Module TransferOrderModule
    ...
    Friend Function AddDocDetail(ByVal globalVariable As GlobalVariable, ByVal documentId As Integer, ByVal documentShopID As Integer, ByVal materialID As Integer,
        ...
        Catch ex As Exception
            ...
            dbTrans.Rollback()
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "AddDocDetail", "99", ex.ToString)
            Return False
        End Try
        resultText = ""
        Return True
    ...
    Friend Function ApproveDocument(ByVal globalVariable As GlobalVariable, ByVal documentId As Integer, ByVal documentShopId As Integer, ByRef resultText As String) As Boolean
        ...
        Catch ex As Exception
            resultText = ex.ToString
            dbTrans.Rollback()
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "ApproveDocument", "99", ex.ToString)
            Return False
        End Try
        resultText = ""
        Return True
    ...
    Friend Function CancelDocument(ByVal globalVariable As GlobalVariable, ByVal documentId As Integer, ByVal documentShopId As Integer, ByRef resultText As String) As Boolean
        ...
        Catch ex As Exception
            ...
            dbTrans.Rollback()
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "CancelDocument", "99", ex.ToString)
            Return False
        End Try
        resultText = ""
        Return True
    ...
    Friend Function InsertNotEnoughStockMaterialIntoList(ByVal dtNotEnoughStock As DataTable) As List(Of MaterialNotEnoughStock_Data)
        ...
        For i = 0 To dtNotEnoughStock.Rows.Count - 1
            ...
            Else
                dclTransferAmount = 0
            End If
            strTransferAmount = MaterialAmountInLargeUnit(dtNotEnoughStock, curMaterialID,
            ...
            Else
                dclCurrentAmount = 0
            End If
            strCurrentAmount = MaterialAmountInLargeUnit(dtNotEnoughStock, curMaterialID,
    ...
    Friend Function SearchDocument(ByVal globalVariable As GlobalVariable, ByVal documentStatus As Integer, ByVal startDate As Date, ByVal endDate As Date,
                                   ByVal searchInventoryID As Integer, ByVal searchToInventoryId As Integer, ByRef docList As List(Of SearchDocumentResult_Data),
        ...
        End If
        Try
            dtResult = DocumentSQL.SearchDocument(globalVariable.DocDBUtil, globalVariable.DocConn, globalVariable.DOCUMENTTYPE_TRANSFER, strFromDate, strToDate,
                                                       documentStatus, searchInventoryID, searchToInventoryId, globalVariable.DocLangID)
        ...
        Catch ex As Exception
            resultText = ex.Message
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "SearchDocument", "99", ex.ToString)
            Return False
        End Try
        resultText = ""
        Return True
    ...
    Friend Function SaveDocumentDataIntoDB(ByVal globalVariable As GlobalVariable, ByVal documentId As Integer, ByVal inventoryID As Integer, ByVal toInventoryId As Integer,
        ...
        dbTrans = globalVariable.DocConn.BeginTransaction(IsolationLevel.Serializable)
        Try
            DocumentSQL.UpdateDocument(globalVariable.DocDBUtil, globalVariable.DocConn, dbTrans, documentId, inventoryID, toInventoryId, strDocDate, strDueDate, Trim(documentNote), Trim(invoiceReference), strUpdateDate, globalVariable.StaffID)
            dbTrans.Commit()
        Catch ex As Exception
            resultText = ex.ToString
            dbTrans.Rollback()
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "SaveDocumentDataIntoDB", "99", ex.ToString)
            Return False
        End Try
    ...
    Friend Function UpdateDocDetail(ByVal globalVariable As GlobalVariable, ByVal documentId As Integer, ByVal documentShopID As Integer, ByVal docDetailId As Integer,
        ...
        Catch ex As Exception
            resultText = ex.ToString
            dbTrans.Rollback()
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "UpdateDocDetail", "99", ex.ToString)
            Return False
        End Try
        resultText = ""
        Return True
    ...
    Friend Function DeleteDocDetail(ByVal globalVariable As GlobalVariable, ByVal documentId As Integer, ByVal documentShopId As Integer, ByVal strDocDetailId As String,
        ...
        Catch ex As Exception
            resultText = ex.ToString
            dbTrans.Rollback()
            DocumentSQL.InsertLog(globalVariable.DocDBUtil, globalVariable.DocConn, "TransferOrderModule", "DeleteDocDetail", "99", ex.ToString)
            Return False
        End Try
