...
Public Class DailyStockController
    ...
    Public Function ApproveDocument(ByVal documentID As Integer, ByVal documentShopID As Integer, ByRef docData As Document_Data, ByRef resultText As String) As Boolean
        ...
        '    Return False
        'End If
        If CountStockModule.ApproveDocument(globalVariable, globalVariable.DOCUMENTTYPE_DAILYSTOCK, documentID, documentShopID, resultText) = False Then
            Return False
        End If
    ...
    Public Function ApproveDocument(ByVal documentID As Integer, ByVal documentShopID As Integer, ByVal inventoryID As Integer,
        ...
        '    Return False
        'End If
        If CountStockModule.SaveDocumentDataIntoDB(globalVariable, globalVariable.DOCUMENTTYPE_DAILYSTOCK, documentID, documentShopID, inventoryID, documentDate, documentNote, resultText) = False Then
            Return False
        End If
        If CountStockModule.ApproveDocument(globalVariable, globalVariable.DOCUMENTTYPE_DAILYSTOCK, documentID, documentShopID, resultText) = False Then
            Return False
    ...
    Public Function CreateNewDocument(ByVal inventoryID As Integer, ByVal documentDate As Date, ByVal documentNote As String,
        ...
        'If documentDate <> Date.Today Then
        '    resultText = globalVariable.MESSAGE_INVALIDDATECOUNTSTOCK
        '    Return False
        'End If
        If DocumentModule.CheckWorkingDocument(globalVariable, globalVariable.DOCUMENTTYPE_DAILYSTOCK, documentDate, inventoryID, documentId, documentShopId, resultText) = False Then
            If DocumentModule.CreateNewDocument(globalVariable, globalVariable.DOCUMENTTYPE_DAILYSTOCK, inventoryID, inventoryID, documentDate, docData, resultText) = False Then
                Return False
            End If
            If CountStockModule.SaveDocumentDataIntoDB(globalVariable, docData.DocumentID, docData.DocumentShopID, inventoryID, globalVariable.DOCUMENTTYPE_DAILYSTOCK, documentDate, documentNote, resultText) = False Then
                Return False
            End If
            If CountStockModule.AutoAddDocDetail(globalVariable, docData.DocumentID, docData.DocumentShopID, "DailyStockMaterial", resultText) = False Then
                Return False
            End If
    ...
    Public Function SearchDocument(ByVal documentStatus As Integer, ByVal startDate As Date, ByVal endDate As Date, ByVal inventoryId As Integer,
        ...
        Return CountStockModule.SearchDocument(globalVariable, documentStatus, startDate, endDate, globalVariable.DOCUMENTTYPE_DAILYSTOCK, inventoryId, docList, resultText)
    End Function
    ...
    Public Function SaveDocument(ByVal documentID As Integer, ByVal documentShopID As Integer, ByVal inventoryID As Integer,
        ...
        If CountStockModule.SaveDocumentDataIntoDB(globalVariable, globalVariable.DOCUMENTTYPE_DAILYSTOCK, documentID, documentShopID,
                                                   inventoryID, documentDate, documentNote, resultText) = False Then
            Return False
        End If
